...
class InformesFrame(ctk.CTkFrame):
    ...
    def crear_interfaz(self):
        ...
        self.boton_excel.grid(row=0, column=1, padx=8)
        ...
        self.boton_pdf.grid(row=0, column=2, padx=8)
        ...
        self.resultado_label.grid(row=3, column=0, sticky="w", padx=20, pady=(0, 5))

        self.tabla_frame = ctk.CTkFrame(self, fg_color="white", corner_radius=0)
        self.tabla_frame.grid(row=4, column=0, sticky="nsew", padx=20, pady=(0, 20))
    ...
    def mostrar_resultados(self):
        ...
        for indice, (identificador, titulo) in enumerate(zip(columnas, self.datos_actuales["columnas"])):
            ...
            ancho = 180 if titulo in ("Cliente", "Concepto", "Observaciones") else 110
            self.tabla.column(
                identificador,
                width=ancho,
                anchor="w",
                stretch=titulo in ("Cliente", "Concepto", "Observaciones"),
            )
